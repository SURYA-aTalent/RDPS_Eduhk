    ...
    extends AssignedQuestion
{
    ...
    public static class Children {
        ...
        protected List<AssignedQuestion> questionOrComplexQuestion;
         ...
         * 
         */
        public List<AssignedQuestion> getQuestionOrComplexQuestion() {
            if (questionOrComplexQuestion == null) {
                questionOrComplexQuestion = new ArrayList<AssignedQuestion>();
            }
