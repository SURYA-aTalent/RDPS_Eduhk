 ...
 * 
 */
@WebServiceClient(name = "UserWebService", targetNamespace = "http://ws.mrted.com/", wsdlLocation = "https://api3.lumesse-talenthub.com/User/SOAP/User?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERWEBSERVICE_QNAME = new QName("http://ws.mrted.com/", "UserWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://api3.lumesse-talenthub.com/User/SOAP/User?wsdl");
    ...
    public UserWebService getUserWebServicePort() {
        return super.getPort(new QName("http://ws.mrted.com/", "UserWebServicePort"), UserWebService.class);
    }
    ...
    public UserWebService getUserWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.mrted.com/", "UserWebServicePort"), UserWebService.class, features);
    }
